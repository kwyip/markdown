...
% Block diagram
\usepackage{tikz}
\begin{filecontents}{block-diagram.tex}
\centering
\ifx\du\undefined
  \newlength{\du}
\fi
...
\definecolor{dialinecolor}{rgb}{0.000000, 0.000000, 0.000000}
\pgfsetstrokecolor{dialinecolor}
\node at (8.127254\du,-2.705000\du){\LaTeX{} Interface};
\definecolor{dialinecolor}{rgb}{1.000000, 1.000000, 1.000000}
\pgfsetfillcolor{dialinecolor}
...
\definecolor{dialinecolor}{rgb}{0.000000, 0.000000, 0.000000}
\pgfsetstrokecolor{dialinecolor}
\node at (-1.080135\du,-2.743555\du){\Hologo{ConTeXt} Interface};
\definecolor{dialinecolor}{rgb}{1.000000, 1.000000, 1.000000}
\pgfsetfillcolor{dialinecolor}
...
\definecolor{dialinecolor}{rgb}{0.000000, 0.000000, 0.000000}
\pgfsetstrokecolor{dialinecolor}
\node at (1.835000\du,0.820004\du){Plain \TeX{} Interface};
\definecolor{dialinecolor}{rgb}{1.000000, 1.000000, 1.000000}
\pgfsetfillcolor{dialinecolor}
...
\definecolor{dialinecolor}{rgb}{0.000000, 0.000000, 0.000000}
\pgfsetstrokecolor{dialinecolor}
\node at (0.325000\du,4.370006\du){Lua Interface};
\pgfsetlinewidth{0.040000\du}
\pgfsetdash{}{0pt}
\pgfsetdash{}{0pt}
\pgfsetbuttcap
...
\global\def\subsecname{Quick Overview of the Package}

\begin{frame}

### \subsecname
#### A Block Diagram of the Package
...
local convert = markdown.new({ something = true })
local input = "Some _Markdown_ text."
print(convert(input))
```
...
\usepackage[something]{markdown}
\markdownSetup{renderers = {somethingElse = {\foo{#1}}}}
\begin{document}
\markdownInput{bar.md}
\begin{markdown}
Some _Markdown_ text.
...
(This actually does not work out-of-box at the moment.)
...
#### The Missing Pieces of the Puzzle
  ...
  * \TeX\ comments in hybrid code behave in an unexpected way.
  * Logging should be improved, so that programs such as \texttt{latexmk}
    can automatically remove cache files that are no longer needed.
